...
| `corpora/calvin-institutes-1559-beveridge/fingerprints.txt` | 2,260 `<locator>  <sha256>` lines | Regenerated by `make bless` |
...
- Produces: `chunk_count: 2260` and `edition_check.diagnostic: Inst. 4.17.10.p1` in the manifest;
  2,260 lines in the fingerprints file. Task 5 records the count.
...
Expected: `chunk_count: 2260`; `diagnostic: Inst. 4.17.10.p1`; `expected_sha256` unchanged;
`verified` today's date and `verified_by` your name; 2,260 lines in the fingerprints file.
...
git commit -m "Re-bless the Institutes at 2,260 paragraphs

1,284 locators out and 2,260 in, of which 1,132 carry byte-identical
...
- The chunk-count paragraph: `1,284 chunks: 1,277 body sections …` becomes 2,260 chunks — 2,177
  body and 83 prefatory — across 1,277 body sections and the prefatory address's seven.
